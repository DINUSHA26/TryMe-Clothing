...
const protectedRoutes: Record<string, Role[]> = {
  ...
  // ── Customer API routes ───────────────────────────────────────────────────
  "/api/cart": ["CUSTOMER", "VENDOR", "ADMIN"],
  "/api/addresses": ["CUSTOMER", "VENDOR", "ADMIN"],
  "/api/checkout": ["CUSTOMER", "VENDOR", "ADMIN"],
  "/api/orders": ["CUSTOMER", "ADMIN", "VENDOR"],
  "/api/disputes": ["CUSTOMER", "VENDOR", "ADMIN"],
  "/api/reviews": ["CUSTOMER", "VENDOR", "ADMIN"],
  "/api/payments/initiate": ["CUSTOMER", "VENDOR", "ADMIN"],
  "/api/payments/bank-transfer": ["CUSTOMER", "VENDOR", "ADMIN"],
  "/api/coupons": ["CUSTOMER", "VENDOR", "ADMIN"],
  // ── Shared API routes ─────────────────────────────────────────────────────
