    ...
    return (
        <Card id={`post-${post.id}`} className="rounded-2xl shadow-sm border-2 overflow-hidden">
            ...
            <CardContent className="p-4 pt-1">
                ...
                {post.productSlug && (
                    <div className="mt-4 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/20 p-3 rounded-xl border border-slate-100 dark:border-slate-800 gap-2">
                        {post.tagType === "AD" ? (
                            <>
